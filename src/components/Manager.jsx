...
const Manager = () => {
    ...
    const gettingdata=async()=>{
        let res = await fetch("http://passopbackend2.onrender.com")
    ...
    const Savepassword = async () => {
        ...
        let res = await fetch("http://passopbackend2.onrender.com/Adddata", { method: "post", headers: { "Content-type": "application/json" }, body: JSON.stringify({ ...Form, Id: temp_ID }) })
        console.log(res)
    ...
    const Deletedata = async (Iddelete) => {
        let res = await fetch("http://passopbackend2.onrender.com/Delete", { method: "post", headers: { "Content-type": "application/json" }, body: JSON.stringify({ Id: Iddelete }) })
        gettingdata();
            ...
            <div className="mx-auto my-14 max-w-5xl py-4 px-4 md:px-10 lg:px-40">
                ...
                <div className="Passwords">
                    ...
                    {passwordarray.length !== 0 && (
                        <div className="">
                            <table className="table-auto w-[80%] md:w-full overflow-hidden rounded-2xl">
                                <thead >
